...
class WaterLevelChart {
  ...
  initVis() {
    ...
    vis.yLabel = vis.g
      ...
      .text("Water Level From TOP (Mtrs)")
      .style("font-size", FONTSIZE["axis-label"]);
  ...
  updateVis() {
    ...
    vis.y.domain([
      d3.min(vis.dataFiltered, (c) => d3.min(c.values, (d) => d.waterLevel)) -
        5,
      d3.max(vis.dataFiltered, (c) => d3.max(c.values, (d) => d.waterLevel)),
    ]);
        ...
        d3
          ...
          .attr("transform", function (d, i) {
            ...
            return (
              ...
              "," +
              vis.y(d.values[vis.idx - 1].waterLevel) +
              ")"
            );
          }),
